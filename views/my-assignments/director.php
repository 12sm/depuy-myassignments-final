                ...
                <div class="myAssignments">
                  ...
                  <div class="row">
                    <div class="date-width col-xs-3 col-sm-2 col-md-1 col-lg-1">
											<p>
                        Due<span class="visHid">.</span>Date
                      </p>
                    </div>
                  ...
                  <div class="row">
                    ...
                    <div class="assignment-width col-xs-9 col-sm-10 col-md-11 col-lg-11">
                      <div class="row">
                        <div class="col-xs-12">
                          <h3 class="course_description"> <a href="show-ordered.php">Name Of Resident Assignment</a> </h3>
                        </div>
                      </div>
                      <div class="row">
                        <div class="col-xs-12">
                          <p class="course_contents course_location"> 3/10 Residents have completed </p>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    ...
                    <div class="assignment-width col-xs-9 col-sm-10 col-md-11 col-lg-11">
                      ...
                      <div class="row">
                        <div class="col-xs-12">
                          <p class="course_contents course_location"> 0/5 Residents have completed </p>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    ...
                    <div class="assignment-width col-xs-9 col-sm-10 col-md-11 col-lg-11">
                      ...
                      <div class="row">
                        <div class="col-xs-12">
                          <p class="course_contents course_location"> 1/8 Residents ahve completed </p>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    ...
                    <div class="assignment-width col-xs-9 col-sm-10 col-md-11 col-lg-11">
                      ...
                      <div class="row">
                        <div class="col-xs-12">
                          <p class="course_contents course_location"> 0/10 Residents have completed </p>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="myAssignments">
                  ...
                  <div class="row">
                    <div class="assignment-width col-xs-11 col-sm-10 col-md-11 col-lg-11">
                      ...
                      <div class="row">
                        <div class="col-xs-12">
                          <p class="course_contents course_location"> 2 PDFs, 3 Videos, 2 Journal Articles, 1 Podcast, 1 Course, 1 Event </p>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="row">
                    <div class="assignment-width col-xs-11 col-sm-10 col-md-11 col-lg-11">
                      ...
                      <div class="row">
                        <div class="col-xs-12">
                          <p class="course_contents course_location"> 2 PDFs, 3 Videos </p>
                        </div>
                      </div>
                    </div>
                    <div class="col-xs-1 col-sm-2 col-md-1 col-lg-1 center">
                  ...
                  <div class="row">
                    <div class="assignment-width col-xs-11 col-sm-10 col-md-11 col-lg-11">
                      ...
                      <div class="row">
                        <div class="col-xs-12">
                          <p class="course_contents course_location"> 7 Events </p>
                        </div>
                      </div>
                    </div>
                    <div class="col-xs-1 col-sm-2 col-md-1 col-lg-1 center">
                  ...
                  <div class="row">
                    <div class="assignment-width col-xs-11 col-sm-10 col-md-11 col-lg-11">
                      ...
                      <div class="row">
                        <div class="col-xs-12">
                          <p class="course_contents course_location"> 3 Courses, 1 Event </p>
                        </div>
                      </div>
                    </div>
                    <div class="col-xs-1 col-sm-2 col-md-1 col-lg-1 center">
