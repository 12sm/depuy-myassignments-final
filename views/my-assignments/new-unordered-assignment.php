                  ...
                  <div class="col-xs-12">
                    <div class="row">
                      ...
                      <div class="col-xs-11">
                        ...
                        <div id="mat1" class="row list-item-content">
                          <div class="col-xs-12">
                            ...
                            <div>
                              <p class="list-item-type capitalize">
                                Video, 01:35</p>
                              <p class="list-item-excerpt">With 19 lab stations, six training rooms and eight conference rooms, the 75,000 square foot DePuy Institute is the largest...</p>
                            </div>
                          </div>
                        </div>
                      </div>
                  ...
                  <div class="col-xs-12">
                    <div class="row">
                      ...
                      <div class="col-xs-11">
                        ...
                        <div id="mat2" class="row list-item-content">
                          <div class="col-xs-12">
                            <div class="pull-left list-thumb">
                              <a href="/views/my-assignments/single.php" class="play-icon">
                                <img src="../../img/play-button.png">
                  ...
                  <div class="col-xs-12">
                    <div class="row">
                      ...
                      <div class="col-xs-11">
                        ...
                        <div id="mat4" class="row list-item-content">
                          <div class="col-xs-12">
                            <div class="pull-left list-thumb">
                  ...
                  <div class="col-xs-12">
                    <div class="row">
                      ...
                      <div class="col-xs-11">
                        ...
                        <div id="mat5" class="row list-item-content">
                          <div class="col-xs-12">
                            <div class="pull-left list-thumb">
                              <a href="/views/my-assignments/single.php" class="play-icon">
                                <img src="../../img/play-button.png">
                  ...
                  <div class="col-xs-12">
                    <div class="row">
                      ...
                      <div class="col-xs-11">
                        ...
                        <div id="mat6" class="row list-item-content">
                          <div class="col-xs-12">
                            <div class="pull-left list-thumb">
                              <a href="/views/my-assignments/single.php" class="play-icon">
                                <img src="../../img/play-button.png">
                  ...
                  <div class="myAssignments">
                    <div class="row">
                      <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                        <div class="row">
                          <div class="col-xs-12">
                            <h2 class="grayed">NAME OF ASSIGNMENT</h2>
                          </div>
                        </div>
                        <div class="row">
                          <div class="col-xs-12">
                        ...
                        <div class="row">
                          <div class="col-xs-12">
                            <h2 class="grayed">DUE DATE (OPTIONAL)</h2>
                          </div>
                        </div>
                        <div class="row">
                          <div class="col-xs-4 col-sm-3 col-md-4">
                            <input class="form-control" type="text" id="myDate" value="mm/dd/yyyy">
                          </div>
                          <div class="col-xs-1 col-sm-1 col-md-1">
                            <a href="#"><span class="pull-right glyphicon icon-cal tan"></span></a>
                          </div>
                        </div>
                        <div class="row">
                          <div class="col-xs-12">
                            <h2 class="grayed">Message (OPTIONAL)</h2>
                          </div>
                        </div>
                        <div class="row">
                          <div class="col-xs-12">
                            <textarea placeholder="I’ve put together this assignment to prepare you for your practum on June 19. Please take some time to look at the resources attached. Please attend Dr. Marshall’s event on Cold and Flu Season. Let me know if you have any questions." class="form-control"></textarea>
                          </div>
                        </div>
                      </div>
                      <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                            ...
                            <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
                              <div class="panel-body">
                                ...
                                <div class="row invited-resident">
                                  ...
                                  <div class="col-xs-3">
                                    <p class='small-grey pull-right'>pending</p>
                                  </div>
                                </div>
                              </div>
                            </div>
              ...
              <div class="modSpacer new-assignment-form">
                <div class="smtContentWrapper">
                  <div class="myAssignments">
                    <div class="row">
                      <div class="col-xs-12">
                        <h2 class="grayed">Sequential Assignment?</h2>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-xs-12">
                        <p>Would you like residents to complete this assignment in a specific order?</p>
                      </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row resources-row">
                      <div class="col-xs-12">
                        <h2 class="grayed">Resources</h2>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-xs-12">
                        <p>Search for and add the resource, eLearning or event that you would like to include in this assignment.</p>
                      </div>
                    </div>
                      ...
                      <div class="col-xs-11 col-md-11">
                        ...
                        <div class="row list-item-content">
                          <div class="col-xs-12">
                            ...
                            <div>
                                  <p class="list-item-type">eLearning, 50 credits</p>
                                  <p>With 19 lab stations, six training rooms and eight conference rooms, the 75,000 square foot DePuy Institute is the largest...</p>
                            </div>
                        </div>
                        </div>
                      </div>
                    ...
                    <div class="row single-class">
                      <div class="seqNumber sequence-width displayNoneSon col-xs-2 col-md-1">
                        <input class="" type="number" min="1" max="99" value="1">
                      </div>
                      <div class="col-xs-11 col-md-11">
                        <div class="row procedure_details">
                        ...
                        <div class="row list-item-content">
                          <div class="col-xs-12">
                            ...
                            <div>
                              <p class="list-item-type capitalize">
                                Video, 01:35</p>
                              <p class="list-item-excerpt">Detailed description on how to mix, prepare and implant CRANIOS REINFORCED Fast Set Putty.~</p>
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="row">
                      <div class="col-xs-9 col-sm-10 col-lg-11">
                        <input class="form-control" type="text" placeholder="Search Resources">
                      </div>
                      <div class="col-xs-3 col-sm-2 col-lg-1">
                        <button type="button" class="pull-right btn button-lg button-modal btn-info-sm" data-toggle="modal" data-target=".bs-example-modal-lg">Search</button>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-xs-12">
                    ...
                    <div class="row">
                      <div class="col-xs-5 col-sm-3 col-md-3 col-lg-2">
                        <button class="pull-left btn button-lg button-modal gray closeBtn">Save For Later</button>
                      </div>
                      ...
                      <div class="col-xs-3 col-sm-2 col-md-2 col-lg-1">
                        <button class="pull-right btn button-lg button-modal">Create</button>
                      </div>
                    </div>
                  </div>
                </div>
