                      ...
                      <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                        ...
                        <div class="row">
                          ...
                          <div class="col-xs-1 col-sm-1 col-md-1">
                            <span class="pull-right glyphicon icon-cal tan"></span>
                          </div>
                        </div>
                        <div class="row">
                          <div class="col-xs-12">
                  ...
                  <div class="myAssignments">
                    ...
                    <div class="row">
                      ...
                      <div class="col-xs-3 col-sm-2 col-lg-1">
                        <button type="button" class="pull-right btn button-lg button-modal" data-toggle="modal" data-target=".bs-example-modal-lg">Search</button>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-xs-12">
                    ...
                    <div class="row">
                      ...
                      <div class="col-xs-4 col-sm-4 col-md-2 col-lg-2 save-changes-btn">
                        <button class="pull-right btn button-lg button-modal">Save Changes</button>
                      </div>
                    </div>
                  </div>
                </div>
