<div class="column_nav">
  <nav class="main_nav">
    <ul class="-menu list-unstyled nav_list" id="accordion6">
      ...
      <li class="active nav-assignments"><a href="/assignments" class="nav_assignments">My Assignments<span class="pull-right glyphicon icon-assignments center">4</span></a></li>
