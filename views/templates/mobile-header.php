  ...
  <div class="white-bg">
    ...
    <div id="mobileDropdown" class="dropdown mobile_nav_button pull-left">
      ...
      <ul class="dropdown-menu mobile-nav" id="accordion5">
        ...
        <li class="active"><a href="/my-assignments" class="">My Assignments<span class="pull-right glyphicon icon-assignments center">4</span></a></li>
        <li class="mobile-nav-break"></li>
        <li class=""><a href="/">Home<span class="pull-right glyphicon icon-home"></span></a></li>



        <li class="mobile-knowledge-drop">
